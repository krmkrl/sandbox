...
class Tester(unittest.TestCase):
    ...
    def test_five(self):
        nums = [-2,1,3,-2,3]
        subsum = self.sol.maxSubArray(nums)
        self.assertEquals(subsum, 5)
    
    def test_custom(self):
        nums = [-2,4,-4,-4,-1,2,1,0,-1,0,3,4]
        subsum = self.sol.maxSubArray(nums)
        self.assertEquals(subsum, 9)

    def test_custom_trix(self):
        nums = [-2,4,-3,4,-1,2,1,0,-5,0,3,4]
        subsum = self.sol.maxSubArray(nums)
        self.assertEquals(subsum, 9)
